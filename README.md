...
Интерфейс `CatalogComparator` уже описывает требуемые операции. Последовательно реализуйте четыре TODO в модели `Product` и классе `DefaultCatalogComparator`:
...
`bin/main.dart` уже содержит один консольный пример. После реализации интерфейса он должен вывести изменившиеся id и три коротких лога.
